...
public class CandidaturaService {
    ...
    public CandidaturaResponseDTO candidatar(Long candidatoId, CandidaturaRequestDTO request) {
        ...
        // RNF010 — Previne candidatura duplicada
        ...
        // dataCandidatura preenchida pelo @PrePersist
    ...
    // RF009 — Detalhar candidatura específica garantindo que pertence ao candidato
    @Transactional(readOnly = true)
